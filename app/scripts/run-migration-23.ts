...
const sqlContent = readFileSync('/tmp/concludo-repo/app/supabase/migrations/20260911230000_autonomous_strategic_operations.sql', 'utf8');

// Split SQL content into manageable sections for execution
const sections = [
  // 1. Digital Twins Table
...
CREATE INDEX IF NOT EXISTS idx_strategic_alerts_deleted_at ON public.strategic_alerts(deleted_at);`,
  ...
  // 6. RLS Policies for Digital Twins and Strategic Health Scores
  `
DROP POLICY IF EXISTS "Users can view accessible digital twins" ON public.strategic_digital_twins;
...
DROP POLICY IF EXISTS "Users can insert digital twins" ON public.strategic_digital_twins;
...
DROP POLICY IF EXISTS "Users can update own or org digital twins" ON public.strategic_digital_twins;
...
DROP POLICY IF EXISTS "Users can delete own or org digital twins" ON public.strategic_digital_twins;
...
DROP POLICY IF EXISTS "Users can view accessible strategic health scores" ON public.strategic_health_scores;
...
DROP POLICY IF EXISTS "Users can insert strategic health scores" ON public.strategic_health_scores;
...
DROP POLICY IF EXISTS "Users can update own or org strategic health scores" ON public.strategic_health_scores;
...
DROP POLICY IF EXISTS "Users can delete own or org strategic health scores" ON public.strategic_health_scores;
...
`,
  ...
  // 7. RLS Policies for Scenarios, Briefings, and Alerts
  `
DROP POLICY IF EXISTS "Users can view accessible strategic scenarios" ON public.strategic_scenarios;
...
DROP POLICY IF EXISTS "Users can insert strategic scenarios" ON public.strategic_scenarios;
...
DROP POLICY IF EXISTS "Users can update own or org strategic scenarios" ON public.strategic_scenarios;
...
DROP POLICY IF EXISTS "Users can delete own or org strategic scenarios" ON public.strategic_scenarios;
...
DROP POLICY IF EXISTS "Users can view accessible strategic briefings" ON public.strategic_briefings;
...
DROP POLICY IF EXISTS "Users can insert strategic briefings" ON public.strategic_briefings;
...
DROP POLICY IF EXISTS "Users can update own or org strategic briefings" ON public.strategic_briefings;
...
DROP POLICY IF EXISTS "Users can delete own or org strategic briefings" ON public.strategic_briefings;
...
DROP POLICY IF EXISTS "Users can view accessible strategic alerts" ON public.strategic_alerts;
...
DROP POLICY IF EXISTS "Users can insert strategic alerts" ON public.strategic_alerts;
...
DROP POLICY IF EXISTS "Users can update strategic alerts" ON public.strategic_alerts;
...
DROP POLICY IF EXISTS "Users can delete strategic alerts" ON public.strategic_alerts;
...
`,
  ...
  // 8. RPC Functions for Retention, Soft-Delete, Restore and Permanent Delete
  `
